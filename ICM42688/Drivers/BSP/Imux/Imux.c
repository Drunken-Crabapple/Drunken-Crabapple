...
{	
	Angle->roll  =  atan2(2.0f*(q0*q1 + q2*q3),q0*q0 - q1*q1 - q2*q2 + q3*q3)*57.3f;
	Angle->pitch =  asin (2.0f*(q0*q2 - q1*q3))*57.3f;
    Angle->yaw   =  atan2(2.0f*(q0*q3 + q1*q2),q0*q0 + q1*q1 - q2*q2 - q3*q3)*57.3f;
}
