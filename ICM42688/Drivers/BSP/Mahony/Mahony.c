...
{
    roll_mahony  = atan2f(2.0f*(q0*q1 + q2*q3), 1.0f - 2.0f*(q1*q1 + q2*q2)) * 57.29578f;
    pitch_mahony = asinf(-2.0f*(q1*q3 - q0*q2)) * 57.29578f;
    yaw_mahony   = atan2f(2.0f*(q0*q3 + q1*q2), 1.0f - 2.0f*(q2*q2 + q3*q3)) * 57.29578f;
}
float getRoll() {
